...
for row in reader:
	...
	if(event=="event"):
		continue
	print(event,type,place,place1,date,time)
	mydata={'event':event,'type':type,'place':place,'place1':place1,'date':date,'time':time}   #The first is the var name the second is the value
